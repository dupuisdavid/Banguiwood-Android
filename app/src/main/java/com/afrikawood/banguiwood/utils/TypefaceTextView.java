...
//import fr.castorama.castoramaMaMaisonMesProjets.R;
//
///**
...
//                if (typeface == null) {
//                	
//                    typeface = Typeface.createFromAsset(context.getAssets(), String.format("%s.ttf", typefaceName));
//                    
